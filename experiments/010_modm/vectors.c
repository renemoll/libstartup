...
void CAN3_TX_IRQHandler(void)					__attribute__((weak, alias("Undefined_Handler")));
void CAN3_RX0_IRQHandler(void)					__attribute__((weak, alias("Undefined_Handler")));
void CAN3_RX1_IRQHandler(void)					__attribute__((weak, alias("Undefined_Handler")));
void CAN3_SCE_IRQHandler(void)					__attribute__((weak, alias("Undefined_Handler")));
void JPEG_IRQHandler(void)						__attribute__((weak, alias("Undefined_Handler")));
...
FunctionPointer vectorsRom[] =
{
	...
	DFSDM1_FLT0_IRQHandler,					//  99
	DFSDM1_FLT1_IRQHandler,					// 100
	DFSDM1_FLT2_IRQHandler,					// 101
	DFSDM1_FLT3_IRQHandler,					// 102
	SDMMC2_IRQHandler,						// 103
	CAN3_TX_IRQHandler,						// 104
	CAN3_RX0_IRQHandler,					// 105
	CAN3_RX1_IRQHandler,					// 106
	CAN3_SCE_IRQHandler,					// 107
	JPEG_IRQHandler,						// 108
	MDIOS_IRQHandler,						// 109
};
